...
import com.example.cheatgz.lostandfoundsystem.adapter.InputTipsAdapter;
...
public class InputTipsActivity extends Activity implements SearchView.OnQueryTextListener, Inputtips.InputtipsListener, OnItemClickListener, View.OnClickListener {
    ...
    public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
        if (mCurrentTipList != null) {
            ...
            setResult(main.RESULT_CODE_INPUTTIPS, intent);
            this.finish();
        }
    }
    ...
    public boolean onQueryTextSubmit(String query) {
        ...
        setResult(main.RESULT_CODE_KEYWORDS, intent);
        this.finish();
        return false;
    }
